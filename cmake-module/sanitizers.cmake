...
if(USE_SANITIZER)
  ...
  if(UNIX)
    ...
    if(USE_SANITIZER MATCHES "([Aa]ddress);([Uu]ndefined)"
      ...
      append("-fsanitize=address,undefined -static-libasan -static-libubsan" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
    elseif(USE_SANITIZER MATCHES "([Aa]ddress)")
      # Optional: -fno-optimize-sibling-calls -fsanitize-address-use-after-scope
      message(STATUS "Building with Address sanitizer")
      append("-fsanitize=address -static-libasan" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
    ...
    elseif(USE_SANITIZER MATCHES "([Uu]ndefined)")
      ...
      append("-fsanitize=undefined -static-libubsan" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
    ...
    elseif(USE_SANITIZER MATCHES "([Tt]hread)")
      ...
      append("-fsanitize=thread -static-libtsan" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
    elseif(USE_SANITIZER MATCHES "([Ll]eak)")
      message(STATUS "Building with Leak sanitizer")
      append("-fsanitize=leak -static-liblsan" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
    else()
      message(
